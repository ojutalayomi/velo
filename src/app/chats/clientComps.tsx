    ...
    <div className={`flex items-center justify-between ${!chaT && "relative"}`}>
      <div className="9f4q9d4a bg-white/55 dark:bg-black/55 flex flex-col h-screen w-full tablets1:w-2/4 relative">
        <div className="flex gap-4 items-center justify-between w-full my-1 px-3 py-2">
          ...
          <button
            onClick={() => setAyo(!ayo)}
            className={`text-gray-600 ${userdata.username !== "Ojutalayo" && "hidden"} hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 cursor-pointer transition-colors duration-300 ease-in-out`}
          >
        ...
        <Swiper
          ...
          className="dark:text-slate-200 !flex flex-col flex-grow w-full"
          id="vufqnuju"
        >
          <SwiperSlide
            className="flex flex-col flex-grow self-stretch justify-center"
            style={{ height: "auto" }}
          >
            {!ayo ||
            filterConversations("all")?.length === undefined ||
            filterConversations("all")?.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Get started by creating any or you can join any.
                </p>
                <div className="mt-6">
                  <button
                    type="button"
          ...
          >
            ...
            filterConversations("Group")?.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Get started by creating or joining a new group.
                </p>
                <div className="mt-6">
                  <button
                    type="button"
          ...
          >
            {!ayo ||
            filterConversations("Archived")?.length === undefined ||
            filterConversations("Archived")?.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Get started by adding chats to your archive.
                </p>
              </div>
            ) : (
        ...
        {/*  */}
        <div
          className={`${createPage ? "absolute z-[1]" : "hidden z-[1]"} bg-gray-100 dark:bg-zinc-900 overflow-auto h-full w-full top-0`}
        >
