...
const ChatTextarea = ({quote, newMessage, setNewMessage,  handleSendMessage, handleTyping, closeQuote}: ChatTextareaProps) => {
    ...
    return (
        <div className="w-full relative">
            <div className="fixed tablets1:absolute bottom-0 left-0 tablets1:left-auto right-0 tablets1:right-auto tablets1:w-full px-4 py-2 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-lg border-t dark:border-zinc-800 z-50">
                {quote.state && (
                    <div 
