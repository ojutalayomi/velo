                        ...
                        <div className='flex items-center gap-2 max-w-3xl mx-auto'>
                            ...
                            <div className={`relative flex flex-1 ${textAreaStyle} overflow-hidden`}>
                                <textarea 
                                    ...
                                    rows={1}
                                />
                                <div className={`absolute right-3 ${isTextAreaFocused ? 'bottom-0' : 'top-1/2'} transform -translate-y-1/2 text-gray-400 flex items-center gap-2`}>
                                    <EmojiPicker onChange={(emoji: string) => textAreaRef.current && (textAreaRef.current.value += emoji)} >
