        ...
        <div id='bottombar' className={`bg-slate-200 dark:bg-zinc-900 px-1.5 ${pathname?.includes('posts') || pathname?.includes('chats') || routes.includes(activeRoute) && 'hidden'} `}>
          ...
          <div id='content' className='!shadow-none'>
            ...
            <div className={`bottombar ft dark:text-slate-200 rout ${activeRoute === 'explore' ? 'active' : ''}`} data-route='explore'>
              <div className='bottombar-icon'  onClick={() => handleClick('explore')}>
              <svg width='30px' height='30px' className='dark:fill-tom dark:stroke-tom' fill='#1C274C' viewBox='0 0 128 128' id='Layer_1' version='1.1' xmlSpace='preserve' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' stroke='#000000' strokeWidth='0.00128'>
