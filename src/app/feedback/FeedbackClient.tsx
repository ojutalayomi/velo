      ...
      <div className="p-4">
        <div className="space-y-4">
          ...
          <button
            ...
            onClick={() =>
              window.open(
                "https://x.com/messages/compose?recipient_id=1150785912697176064",
                "_blank"
              )
            }
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="button"
              className="w-full py-2 px-4 rounded-lg flex items-center justify-center space-x-2 bg-brand hover:bg-tomatom text-white transition duration-300"
            >
