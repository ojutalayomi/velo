...
const ImageContent: React.FC<Props> = ({userdata,onClick}) => {
    ...
    return (
      <div className="cursor-pointer px-2 py-1 rounded-full hover:bg-slate-200 hover:dark:bg-zinc-700 transition-colors duration-150 tablets1:duration-300 flex items-center" onClick={() => onClick(userdata._id)}>
        <Image 
          src={
