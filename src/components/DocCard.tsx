      ...
      <div className="w-full max-w-[70vw] bg-transparent p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="relative group">
            ...
            {/* File Type Badge */}
            <div className="absolute -top-3 -right-3 bg-white p-2 rounded-xl shadow-lg 
                          hover:scale-110 transition-transform duration-200">
              <span className="text-brand text-xs font-medium uppercase">
                {fileType}
              </span>
            </div>
          </div>
          ...
          <div className="text-center space-y-2 w-[90%]">
            <h2 className="text-xl font-semibold truncate max-w-[600px] text-brand hover:text-brand/60 
