...
const FeedbackModal: React.FC<{ isOpen: () => boolean; onClose: () => void }> = ({
  ...
  return (
    <div
      className={`fixed inset-0 flex items-center justify-center z-50 dark:bg-gray-900 bg-gray-200`}
    >
      <div
        className={`relative w-full max-w-md p-6 rounded-lg shadow-lg dark:bg-gray-800 dark:text-white bg-white text-gray-800`}
      >
        <button
          onClick={onClose}
