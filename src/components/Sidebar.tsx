    ...
    return (
      <>
        <div id='sidebar' className={routes.includes(activeRoute) ? 'hidden' : ''}>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === 'explore' ? 'active' : ''}`} data-route='explore'>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === 'create-post' ? 'active' : ''}`} data-action='post-menu' data-route='create-post'>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === 'chats' ? 'active' : ''}`} data-route='chats'>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === 'general' ? 'active' : ''}`} data-route='general'>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === ':username' ? 'active' : ''}`} data-route='<%= username %>'>
            <div className='sidebar-icon'  onClick={() => handleClick('explore')}>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === 'user-interface' ? 'active' : ''}`} data-route='user-interface'>
          ...
          <div className={`sidebar ft fft rout ${activeRoute === 'feedback' ? 'active' : ''}`} data-route='feedback'>
