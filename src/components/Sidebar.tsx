...
import { ChevronRight, RefreshCw, Bell, Lock, User, Moon, HelpCircle, LogIn, LogOut } from 'lucide-react';
      ...
      <>
        <div id='sidebar' className={`${routes.includes(activeRoute) && '!hidden'} hidden tablets:flex flex-col `}>
          ...
          <div className='flex-1 overflow-auto'>
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'home' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route='home'>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'explore' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route='explore'>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'create-post' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-action='post-menu' data-route='create-post'>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'chats' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route='chats'>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'general' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route='general'>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === userdata.username ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route={userdata.username}>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'user-interface' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route='user-interface'>
            ...
            <div className={`sidebar ft dark:text-slate-200 rout ${activeRoute === 'feedback' ? 'active sticky top-0 bottom-0 backdrop-filter backdrop-blur-[5px]' : ''}`} data-route='feedback'>
          ...
          <div ref={ref} className={`user ${!error &&'hover:bg-slate-200 dark:hover:bg-neutral-900'} tablets1:items-center !justify-center tablets1:!justify-between !m-0 w-full`} onClick={handlePopUp}>
              ...
              : 
                ...
                {loading || error ? <div className='animate-pulse w-14 h-4 bg-[#9E9E9E] rounded'></div> : <p className='username text-xs'>@{userdata.username !== '' ? userdata.username : 'Reload'}</p>}
                </div>
