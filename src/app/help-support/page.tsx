...
import { ArrowLeft, HelpCircle, Mail, MessageCircle, Phone, ChevronDown, ChevronUp, FileText, ExternalLink } from 'lucide-react';
...
const HelpSupportPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Go to Settings > Personal Information to update your profile details including name, email, phone number, and other personal information."
    },
    {
      question: "How do I manage my privacy settings?",
      answer: "Navigate to Settings > Privacy & Security to manage your privacy preferences, including who can see your profile and how your information is shared."
    },
    {
    ...
    },
    {
      ...
      answer: "To delete your account, go to Settings > Privacy & Security > Account Management. Please note that this action is irreversible."
    }
  ];
    ...
    <div className="max-h-screen overflow-auto bg-gray-50 dark:bg-zinc-900">
      ...
      <main className="max-w-4xl mx-auto p-4 space-y-6 mb-16 tablets:mb-0">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a href="tel:+1234567890" className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
          ...
          <a href="mailto:support@example.com" className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
            ...
            <p className="text-sm font-medium text-blue-600 dark:text-blue-400">support@example.com</p>
          </a>

          <a href="#live-chat" className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center">
        ...
        <section className="bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="border-b dark:border-neutral-700 last:border-0 pb-4 last:pb-0">
                <button
        ...
        {/* Support Ticket Form */}
        <section className="bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-sm">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Submit a Support Ticket</h2>
